...
public class Mymod1
{
    ...
    public Mymod1()
    {
        ...
        Config.loadConfigFile(Config.CLIENT_CONFIG, FMLPaths.CONFIGDIR.get().resolve("mymod1-client.toml").toString());
        Config.loadConfigFile(Config.SERVER_CONFIG, FMLPaths.CONFIGDIR.get().resolve("mymod1-server.toml").toString());
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("mod1", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
